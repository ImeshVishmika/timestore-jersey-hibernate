...
-- Dumping data for table timestore.admin: ~2 rows (approximately)
...
-- Dumping data for table timestore.brand: ~5 rows (approximately)
...
-- Dumping data for table timestore.buy_now_cart: ~1 rows (approximately)
...
-- Dumping data for table timestore.cart: ~1 rows (approximately)
...
-- Dumping data for table timestore.category: ~6 rows (approximately)
...
-- Dumping data for table timestore.cities: ~1,846 rows (approximately)
...
-- Dumping data for table timestore.delivery_method: ~2 rows (approximately)
INSERT INTO `delivery_method` (`id`, `delivery_method`, `price`, `delivery_days`) VALUES
	(1, 'Express', 360, '4'),
	(2, 'Fast', 0, '4');
...
-- Dumping data for table timestore.districts: ~25 rows (approximately)
...
-- Dumping data for table timestore.gender: ~2 rows (approximately)
...
-- Dumping data for table timestore.invoice: ~11 rows (approximately)
INSERT INTO `invoice` (`invoice_id`, `order_id`, `invoice_date`, `email`, `delivery_fee`) VALUES
	(7001, 5001, '2026-02-28 10:32:24', 'nimal@example.com', 350),
	(7002, 5002, '2026-02-28 10:32:24', 'kavindi@example.com', 750),
	(10940986, 484606335, '2026-02-01 10:27:16', 'imesh@gmail.com', 350),
	(64447022, 969524328, '2026-02-12 11:04:34', 'imesh@gmail.com', 0),
	(66483300, 374916360, '2026-02-12 11:13:36', 'imesh@gmail.com', 0),
	(162612035, 327620435, '2026-02-19 14:17:18', 'imesh@gmail.com', 360),
	(261459875, 321806464, '2026-02-01 10:25:28', 'imesh@gmail.com', 350),
	(852585491, 426274874, '2026-02-01 10:28:40', 'imesh@gmail.com', 350),
	(879938587, 539311991, '2026-02-14 10:17:42', 'imesh@gmail.com', 360),
	(922377363, 197934294, '2026-02-12 09:16:40', 'imesh@gmail.com', 360),
	(966133984, 252847174, '2026-02-25 07:58:32', 'imesh@gmail.com', 0);
...
-- Dumping data for table timestore.invoice_items: ~11 rows (approximately)
INSERT INTO `invoice_items` (`order_id`, `invoice_id`, `product_id`, `product_name`, `product_price`, `qty`) VALUES
	(5001, 7001, 101, 'G-Shock GA-2100', 38990, 1),
	(5002, 7002, 102, 'Seiko Prospex SPB143', 185000, 1),
	(484606335, 10940986, 16, 'MRG-B2000JS-1A', 1200, 1),
	(969524328, 64447022, 16, 'MRG-B2000JS-1A', 1200, 1),
	(374916360, 66483300, 16, 'MRG-B2000JS-1A', 1200, 1),
	(327620435, 162612035, 16, 'SSH186J1', 1300, 1),
	(321806464, 261459875, 16, 'MRG-B2000B-1A4', 1000, 1),
	(426274874, 852585491, 16, 'MRG-B2000JS-1A', 1200, 2),
	(539311991, 879938587, 16, 'NB6069-53H', 1542, 1),
	(197934294, 922377363, 16, 'MRG-B2000-E2', 1111, 2),
	(252847174, 966133984, 115, 'SSH186J1', 1300, 4);
...
-- Dumping data for table timestore.messages: ~5 rows (approximately)
INSERT INTO `messages` (`message_id`, `status`, `message`, `sender`, `subject`, `date_time`) VALUES
	(1, 2, 'I placed an order two days ago and still haven’t received any update. This is frustrating ', 'imesh@gmail.com', 'Order Delay', '2026-02-01 05:40:50'),
	(2, 1, 'he checkout page crashes every time I try to pay. I’ve tested it on two browsers and the issue still occurs.', 'vishmika@gmail.com', 'service is terrible', '2026-02-01 05:40:50'),
	(3, 1, 'I’m disappointed with the delay in my order. I expected better communication and would appreciate a clear update.', 'imesh@gmail.com', 'Delay in Order', '2026-02-02 12:40:50'),
	(4, 1, 'It’s difficult to find my previous orders. The navigation isn’t intuitive and takes too many steps.', 'vishmika@gmail.com', 'service is terrible', '2026-02-02 12:40:50'),
	(5, 1, 'My payment was deducted, but the order wasn’t confirmed. Please resolve this as soon as possible.', 'vishmika@gmail.com', 'navigation is hard', '2026-02-03 12:41:27');
...
-- Dumping data for table timestore.msg_status: ~2 rows (approximately)
...
-- Dumping data for table timestore.order: ~12 rows (approximately)
INSERT INTO `order` (`order_id`, `email`, `ordered_date`, `delivery_method`, `order_status`) VALUES
	(5001, 'nimal@example.com', '2026-02-28 10:32:24', 1, 2),
	(5002, 'kavindi@example.com', '2026-02-28 10:32:24', 2, 1),
	(197934294, 'imesh@gmail.com', '2026-02-12 09:16:40', 1, 1),
	(252847174, 'imesh@gmail.com', '2026-02-25 07:58:32', 2, 1),
	(321806464, 'imesh@gmail.com', '2026-02-01 10:25:28', 1, 1),
	(327620435, 'imesh@gmail.com', '2026-02-19 14:17:18', 1, 1),
	(374916360, 'imesh@gmail.com', '2026-02-12 11:13:36', 2, 1),
	(426274874, 'imesh@gmail.com', '2026-02-01 10:28:40', 1, 1),
	(484606335, 'imesh@gmail.com', '2026-02-01 10:27:16', 1, 1),
	(539311991, 'imesh@gmail.com', '2026-02-14 10:17:41', 1, 1),
	(969524328, 'imesh@gmail.com', '2026-02-12 11:04:34', 2, 1),
	(993320418, 'vishmika@gmail.com', '2026-02-13 21:04:17', 2, 5);
...
-- Dumping data for table timestore.order_status: ~6 rows (approximately)
INSERT INTO `order_status` (`order_status_id`, `status`) VALUES
	(1, 'Order Places'),
	(2, 'Processing & Confirmed'),
	(3, 'Shipped'),
	(4, 'Out for Delivery'),
	(5, 'Deliverd'),
	(6, 'Cancelled');
...
-- Dumping data for table timestore.product: ~8 rows (approximately)
INSERT INTO `product` (`product_id`, `product_name`, `brand_id`) VALUES
	(1, 'MRG-B2000', 1),
	(2, 'Cosmograph Daytona', 3),
	(5, 'NB6030', 8),
	(6, 'NB6060', 8),
	(7, 'NB6060', 8),
	(11, 'NB6062', 8),
	(16, 'SSH1', 2),
	(18, 'Omega Seamaster', 10);
...
-- Dumping data for table timestore.product_has_category: ~2 rows (approximately)
INSERT INTO `product_has_category` (`product_id`, `category_category_id`) VALUES
	(101, 1),
	(102, 2);
...
-- Dumping data for table timestore.model: ~33 rows (approximately)
INSERT INTO `model` (`model_id`, `model`, `product_id`, `price`, `qty`, `added_time`) VALUES
	(12, 'MRG-B2000-E2', 1, 1111, 211, '2025-12-03 13:01:32'),
	(13, 'MRG-B2000JS-1A', 1, 1200, 9, '2025-12-03 13:01:32'),
	(14, 'MRG-B2000RG-3A', 1, 1300, 8, '2025-12-03 13:01:32'),
	(15, 'MRG-B2000B-1A4', 1, 1000, 10, '2025-12-03 13:01:32'),
	(27, 'Cosmograph-Daytona-White-Gold', 2, 1455, 10, '2025-12-03 13:01:32'),
	(28, 'Cosmograph-Daytona-Yellow-Daytona', 2, 1500, 11, '2025-12-03 13:01:32'),
	(89, 'Cosmograph-Daytona-Platinum', 2, 1111, 11, '2026-02-13 12:00:09'),
	(92, 'Cosmograph Daytona Yellow Gold', 2, 1500, 111, '2026-02-13 12:28:01'),
	(93, 'Cosmograph Daytona Oyestersteel', 2, 1000, 18, '2026-02-13 12:36:25'),
	(94, 'Cosmorgraph Daytona Black Gold', 2, 1500, 111, '2026-02-14 12:25:23'),
	(97, 'NB6030-59L', 5, 1000, 11, '2026-02-13 15:10:28'),
	(98, 'NB6031-56E', 5, 1111, 1, '2026-02-13 15:17:18'),
	(99, 'NB6033-51E', 5, 1222, 12, '2026-02-13 15:22:19'),
	(100, 'NB6035-55H', 5, 1234, 12, '2026-02-13 15:43:02'),
	(101, 'NB6060-58H', 7, 1234, 12, '2026-02-13 15:44:56'),
	(102, 'NB6060-58L', 7, 1234, 12, '2026-02-13 16:45:21'),
	(103, 'NB6060-58X', 7, 1234, 12, '2026-02-13 15:45:41'),
	(107, 'NB6062-52P', 11, 1200, 19, '2026-02-13 15:51:44'),
	(108, 'NB6066-51W limited ', 5, 1542, 13, '2026-02-13 15:54:13'),
	(109, 'NB6066-51', 11, 1542, 13, '2026-02-13 15:55:50'),
	(110, 'NB6069-53H', 11, 1542, 12, '2026-02-13 15:56:21'),
	(111, 'SSH161J1', 16, 1300, 12, '2026-02-13 16:01:00'),
	(112, 'SSH183J1', 16, 1300, 12, '2026-02-13 16:01:25'),
	(113, 'SSH187J1', 16, 1300, 12, '2026-02-13 16:01:50'),
	(114, 'SSH175J1', 16, 1300, 12, '2026-02-13 16:02:10'),
	(115, 'SSH186J1', 16, 1300, 7, '2026-02-13 17:02:58'),
	(116, 'Omega-seamaster-planet-ocean', 18, 1000, 11, '2026-02-14 10:32:48'),
	(117, 'Omega seamaster planet ocean', 18, 1000, 11, '2026-02-14 10:34:54'),
	(118, 'Omega seamaster planet ocean', 18, 1000, 11, '2026-02-14 10:35:50'),
	(119, 'Omega seamaster planet ocean', 18, 1000, 11, '2026-02-14 10:35:59'),
	(120, 'Omega seamaster planet ocean', 18, 1000, 11, '2026-02-14 10:36:07'),
	(121, 'Omega seamaster planet ocean', 18, 1000, 11, '2026-02-14 10:36:15'),
	(122, 'Omega seamaster planet ocean', 18, 1000, 11, '2026-02-14 10:36:27');
...
-- Dumping data for table timestore.product_img: ~33 rows (approximately)
INSERT INTO `product_img` (`img_path`, `model_id`) VALUES
	('product/MRG-B2000BG-3A.avif', 12),
	('product/MRG-B2000JS-1A.avif', 13),
	('product/MRG-B2000RG-3A.avif', 14),
	('product/MRG-B2000B-1A4.avif', 15),
	('product/Cosmograph-Daytona-White-Gold_69781aab13464', 27),
	('product/Cosmograph-Daytona-Yellow-Daytona_697828ded66c0', 28),
	('product/Cosmograph-Daytona-Platinum_698ec4f16cc3c', 89),
	('product/Cosmograph Daytona Yellow Gold_698ecb7901458', 92),
	('product/Cosmograph Daytona Oyestersteel_698ecd7145a52', 93),
	('product/Cosmorgraph Daytona Black Gold_698ecadbdd018', 94),
	('product/NB6030-59L_698ef18c014c8', 97),
	('product/NB6031-56E_698ef3263f759', 98),
	('product/NB6033-51E_698ef453822b2', 99),
	('product/NB6035-55H_698ef92e5a2d6', 100),
	('/assets/images/products/ga-2100.jpg', 101),
	('product/NB6060-58H_698ef9a0c39b9', 101),
	('/assets/images/products/spb143.jpg', 102),
	('product/NB6060-58L_698ef9b978a3b', 102),
	('product/NB6060-58X_698ef9cdb930b', 103),
	('product/NB6062-52P_698efb385694c', 107),
	('product/NB6066-51W limited _698efbcd961d3', 108),
	('product/NB6066-51_698efc2e74f66', 109),
	('product/NB6069-53H_698efc4da7462', 110),
	('product/SSH161J1_698efd64eb7dd', 111),
	('product/SSH183J1_698efd7cf4156', 112),
	('product/SSH187J1_698efd9655862', 113),
	('product/SSH175J1_698efdaa36cab', 114),
	('product/SSH186J1_698efddae9300', 115),
	('product/Omega-seamaster-planet-ocean_699001f8ae81b', 116),
	('product/Omega seamaster planet ocean_69900276321d8', 117),
	('product/Omega seamaster planet ocean_699002aea12c0', 118),
	('product/Omega seamaster planet ocean_699002b7dfacc', 119),
	('product/Omega seamaster planet ocean_699002bf041d6', 120),
	('product/Omega seamaster planet ocean_699002c70f303', 121),
	('product/Omega seamaster planet ocean_699002d33670e', 122);
...
-- Dumping data for table timestore.provinces: ~9 rows (approximately)
...
-- Dumping data for table timestore.ratings: ~0 rows (approximately)
...
-- Dumping data for table timestore.users: ~3 rows (approximately)
...
-- Dumping data for table timestore.user_address: ~1 rows (approximately)
INSERT INTO `user_address` (`address_line1`, `address_line2`, `address_city_id`, `users_email`) VALUES
	('Horakad Road', 'Ranjurawa', 1504, 'imesh@gmail.com'),
	('No 22, Main Street', 'Maharagama', 2, 'kavindi@example.com'),
	('No 10, Galle Road', 'Colombo', 1, 'nimal@example.com');
...
-- Dumping data for table timestore.user_history: ~0 rows (approximately)
INSERT INTO `user_history` (`id`, `user_id`, `product_id`, `buy_datetime`, `amount`) VALUES
	...
	(12, NULL, NULL, '2026-02-28 09:41:06', 1);
...
-- Dumping data for table timestore.user_img: ~0 rows (approximately)
...
-- Dumping data for table timestore.user_status: ~2 rows (approximately)
...
-- Dumping data for table timestore.watchlist: ~2 rows (approximately)
